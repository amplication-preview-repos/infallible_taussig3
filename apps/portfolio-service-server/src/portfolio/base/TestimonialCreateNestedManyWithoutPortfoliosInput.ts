...
@InputType()
class TestimonialCreateNestedManyWithoutPortfoliosInput {
...
export { TestimonialCreateNestedManyWithoutPortfoliosInput as TestimonialCreateNestedManyWithoutPortfoliosInput };
